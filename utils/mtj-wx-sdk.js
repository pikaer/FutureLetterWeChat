  ...
  var o, t, g = {
    ...
    P = {
      ...
      setUserInfo: function() {
        ...
        return v().then(function() {
          var e = y(g.storageKeys.userInfo),
            t = a(e, "Object") ? e : {};
          u(n) && (t.tel = h.user.tel = n.substr(n.length - 11)), i(r) && (t.openId = h.user.openId = r), (t.tel || t.openId) && m(g.storageKeys.userInfo, t), a(n, "Undefined") || u(n) || console.error("手机号 ".concat(n, " 不合法")), a(r, "Undefined") || i(r) || console.error("openid ".concat(r, " 不合法"))
        }).catch(function(e) {
          f("setUserInfo", e)
        })
      },
      setUserId: function(o) {
        return Promise.resolve().then(function() {
          if (!(a(o, "String") || a(o, "Number") && Number.isFinite(o))) return Promise.reject(new Error("userId只能是字符串或数字"));
          var e = "" + o,
      ...
      setUserProperty: function(o) {
        return Promise.resolve().then(function() {
          ...
          else if (!a(o, "Object")) return Promise.reject(new Error("userProperty必须是对象"));
    ...
    x = function() {
      ...
      t && t.appKey ? (p.key = t.appKey, g.getLocation = t.getLocation || !1, t.hasPlugin ? module.exports = {
        App: w,
        Page: U
      } : (App = w, Page = U)) : console.error("请设置mtj-wx-sdk.config.js文件中的appKey字段")
    };
  return x(), e.init = x, e
}({});